...
def inbox(request):
    ...
    count = messageRequest.filter(is_read=False).count()
    context = {'messageRequest': messageRequest, 'count': count}
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if sender is not None:
                ...
                newMessage.email = sender.email
            newMessage.save()

            messages.success(request, 'Message sent successfully!')
        else:
            messages.error(request, 'Error while sending message')
